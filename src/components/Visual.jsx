    ...
    <form className='my-10'>
      <div className="my-10 w-[100%] xl:w-[80%] mx-auto flex flex-col lg:flex-row">
        ...
        <div className="flex flex-col basis-1/3 items-center mx-5">
          ...
          <select className="w-[20rem] px-5 mt-5  bg-PrimaryBlue text-BackgroundSand font-semibold text-xl rounded-md h-[2rem]">
            <option>Catla</option>
            <option>Rohu</option>
            <option>Hilsa</option>
        ...
        <div className="basis-1/3 flex flex-col items-center">
          ...
          <div className="flex space-x-3 mt-5">
            <input
              type="date"
              className="w-[8rem] lg:w-[12rem] px-4 border  bg-PrimaryBlue text-BackgroundSand font-semibold text-md border-gray-300 rounded-md h-[2rem]"
            />
            <span className="text-lg">to</span>
            <input
              type="date"
              className="w-[8rem] lg:w-[12rem] px-4 bg-PrimaryBlue text-BackgroundSand border font-semibold text-md border-gray-300 rounded-md h-[2rem]"
            />
          </div>
        </div>
